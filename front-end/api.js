        ...
        try {
          ...
          profissionais.forEach(profissional => {
            ...
            <tr>
                ...
                <td class="table-action"><a href="#formCadastro" class="btn btn-warning" onclick="api.alterarProfissional(${profissional.id})">Alterar</a></td>
                <td class="table-action"><button class="btn btn-danger" onclick="api.excluirProfissionais(${profissional.id})">Excluir</button></td>
            </tr>             
            `
          });
